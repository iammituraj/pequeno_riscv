...
##           /_/                                    /___/              
#############################################################################################################
# Script           : Decode offset address
# Developer        : Mitu Raj, chip@chipmunklogic.com
# Vendor           : Chipmunk Logic™, https://chipmunklogic.com
#
# Description      : This script parses the binary file generated by pqr5asm & decodes the offset address.
#
...
# Function to find offset address from the input binary file
def read_offsetaddr(filename):
    word_size = 4
    word_index = 2  # Index of the third word = Offset address MSB
    try:
...
# Function to write offset address to output file
def write_offsetaddr(addr, filename):
    try:
...
offsetaddr = read_offsetaddr(input_filename)
write_offsetaddr(offsetaddr, output_filename)
