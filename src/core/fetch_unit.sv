...
// Next PC logic
//==================================================================================================
logic [`XLEN-1:0] nxt_pc_pre, nxt_pc_pre_plus4, nxt_pc ;  // Next PC
...
always_comb begin
   case (nxt_pc_sel)
      ...
      3'd1    : nxt_pc_pre = bp_pc        ;  // BP PC
      3'd2    : nxt_pc_pre = ras_ret_addr ;  // RAS PC
...
always_ff @(posedge clk or negedge aresetn) begin
   // Reset
   if (!aresetn) begin
      pc_rg       <= PC_INIT-`XLEN'(4);  // So that in the very next valid cycle, PC become PC_INIT
      pc_valid_rg <= 1'b0 ;
   end
   // Out of reset
   else begin
