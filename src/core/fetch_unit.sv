...
logic [`XLEN-1:0] nxt_gen_pc         ;  // Next PC generated by PC counter
...
//===================================================================================================================================================
// Priority-encoded select for next PC
//===================================================================================================================================================
`ifdef RAS
...
`else
logic [1:0] nxt_pc_sel;  // Priority encoded PC select
always_comb begin
   casez ({i_exu_bu_flush, bp_flush, !i_imem_stall})
      3'b1??  : nxt_pc_sel = 2'd0;  // EXU-BU flush, highest priority
      3'b01?  : nxt_pc_sel = 2'd1;  // Branch predictor flush
      3'b001  : nxt_pc_sel = 2'd2;  // Request PC+4
      default : nxt_pc_sel = 2'd3;  // Hold; stalled
   endcase
end
`endif
...
always_comb begin
   case (nxt_pc_sel)
      3'd0    : nxt_pc = i_exu_bu_pc  ;
      3'd1    : nxt_pc = bp_pc        ;
      3'd2    : nxt_pc = ras_ret_addr ;
      3'd3    : nxt_pc = nxt_gen_pc   ;
      default : nxt_pc = pc_rg        ;  // Hold
   endcase
end
`else
always_comb begin
   case (nxt_pc_sel)
      2'd0    : nxt_pc = i_exu_bu_pc ;
      2'd1    : nxt_pc = bp_pc       ;
      2'd2    : nxt_pc = nxt_gen_pc  ;
      default : nxt_pc = pc_rg       ;  // Hold
   endcase
end
`endif
...
assign nxt_gen_pc   = pc_rst_flag_rg ? PC_INIT : pc_plus_four ;
