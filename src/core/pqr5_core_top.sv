...
logic [`XLEN-1:0] wbu_maccu_result        ;  // Direct writeback or Load data from MACCU (muxed at WBU)
...
opfwd_control inst_opfwd_control (
   ...
   .i_maccu_result      (wbu_maccu_result)     ,
...
writeback_unit #(
   ...
   .o_dwback_or_load_data (wbu_maccu_result),
